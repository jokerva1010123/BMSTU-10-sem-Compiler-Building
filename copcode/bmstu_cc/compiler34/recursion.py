...
gr = read_grammar('grammar42.txt', 'input_grammar42.txt')
print_grammar('Input grammar', gr, 'print421.txt')

gr1 = delete_left_recursion(gr)
print_grammar('Grammar after deleting LR', gr1, 'print422.txt')

out_gr = left_factorization(gr1)
print_grammar('Left factorization', out_gr, 'print423.txt')

write_grammar(out_gr, 'output_grammar42.txt')